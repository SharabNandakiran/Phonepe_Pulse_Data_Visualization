...
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Nanda Kiran",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Nanda Kiran*!
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/SharabNandaKiran/Phonepe_Pulse_Data_Visualization")
